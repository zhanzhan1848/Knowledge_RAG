...
async def get_service_status() -> dict:
    ...
    if _embedding_service:
        try:
            status["embedding_service"]["healthy"] = await _embedding_service.health_check()
        except Exception as e:
